...
export default function Achievements() {
  return (
    ...
    >
      {/* Page Heading */}
      <h2 className="text-5xl md:text-6xl font-extrabold text-center mb-12 drop-shadow-2xl tracking-wide rounded-2xl py-6 shadow-lg">
        <span
      ...
      <div className="bg-gradient-to-br from-yellow-100 via-white to-green-50 p-8 rounded-3xl shadow-xl space-y-6 text-gray-800 max-w-3xl mx-auto">
        ...
        <div>
          ...
          <ul className="list-disc ml-8 text-base">
            <li>
              <strong>Boys Category:</strong> Rakshit R Devadiga, Final Year
              Electrical Branch
            </li>
            <li>
              <strong>Girls Category:</strong> Anitha, Final Year Computer
              Science Branch
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc ml-8 text-base">
            <li>
              <strong>Boys Category:</strong> K. Kishan Sheety, Final Year
              Mechanical Branch
            </li>
            <li>
              <strong>Girls Category:</strong> Anitha, Final Year Computer
        ...
        <div>
          ...
          <ul className="list-disc ml-8 text-base">
            ...
            <li>
              <strong>Total:</strong> 110 individual prizes
            </li>
            <li className="mt-2 text-green-800 font-bold">
              🏆 Our college team won the{" "}
